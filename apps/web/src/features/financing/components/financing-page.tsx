      ...
      <div className="bg-[#F4F7FA]">
        <div className="rk-container max-w-3xl py-16 sm:py-20">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link
              href="/"
              className="inline-flex h-12 items-center justify-center rounded-2xl border border-[#D8D2C4] bg-white px-6 text-sm font-semibold text-[#121826] transition-colors hover:border-[#1E9B8C]/50"
            >
    ...
    <div className="bg-[#F4F7FA]">
      <section className="relative overflow-hidden bg-[#0B1220]">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 15% 20%, rgba(43,184,168,.22), transparent 40%), radial-gradient(circle at 85% 70%, rgba(255,255,255,.06), transparent 35%)",
          }}
        />
        <div className="rk-container relative z-10 py-14 sm:py-16 lg:py-20">
          <p className="inline-flex items-center gap-2 text-xs font-semibold tracking-[0.18em] text-[#1E9B8C] uppercase">
      ...
      <section className="rk-container py-14 sm:py-16">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-3">
          {guarantees.map((key) => (
            ...
            >
              <CheckCircle2 className="size-5 text-[#1E9B8C]" strokeWidth={1.75} />
      ...
      <section className="border-y border-[#E2E8F0] bg-white py-14 sm:py-16">
        <div className="rk-container">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {services.map(({ key, icon: Icon }) => (
              <div
                key={key}
                className="rounded-[18px] bg-[#F4F7FA] px-5 py-6 ring-1 ring-black/[0.03]"
              >
                <span className="flex size-11 items-center justify-center rounded-2xl bg-[#0B1220] text-[#1E9B8C]">
        ...
        <div className="mx-auto grid max-w-4xl gap-4 md:grid-cols-3">
          {steps.map((key, index) => (
            <div
              ...
              className="rounded-[20px] bg-white px-5 py-6 shadow-[0_6px_24px_rgba(15,20,30,.05)] ring-1 ring-black/[0.04]"
            >
              <p className="rk-display text-sm font-bold tracking-[0.16em] text-[#1E9B8C]">
                0{index + 1}
              </p>
      ...
      <section className="rk-container pb-16 sm:pb-20">
        <div className="relative overflow-hidden rounded-[28px] bg-[#0B1220] px-6 py-12 sm:px-10 lg:px-14">
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at 90% 20%, rgba(43,184,168,.25), transparent 40%)",
            }}
          />
          <div className="relative z-10 mx-auto max-w-2xl text-center">
            <div className="mx-auto flex size-12 items-center justify-center rounded-2xl bg-[#1E9B8C]/15 text-[#1E9B8C]">
