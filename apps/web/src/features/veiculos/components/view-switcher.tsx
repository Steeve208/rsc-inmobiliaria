...
import { LayoutGrid, List, Map as MapIcon, Satellite } from "lucide-react";
import { useTranslations } from "next-intl";
import { cn } from "@/lib/utils";
import type { VeiculosView } from "../types";

type Props = {
  view: VeiculosView;
  onChange: (view: VeiculosView) => void;
};

export function ViewSwitcher({ view, onChange }: Props) {
  const t = useTranslations("veiculos.views");
