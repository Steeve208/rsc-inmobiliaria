    ...
    >
      ...
      <label className="block space-y-2">
        ...
        <textarea
          ...
          className="w-full rounded-xl border border-white/10 bg-[#070B14] px-4 py-3 text-sm text-white outline-none placeholder:text-white/35 focus:border-[#1E9B8C]/50"
        />
      </label>
