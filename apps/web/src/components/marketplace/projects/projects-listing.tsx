            ...
            <div className="mt-2 flex items-start justify-between gap-4">
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url(https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=720&q=80)",
                  }}
                />
        ...
        <section className="mt-8 grid gap-4 rounded-xl bg-white px-4 py-5 sm:grid-cols-2 lg:grid-cols-5">
          {TRUST_ITEMS.map(([key, Icon]) => (
            <div key={key} className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-[#0B1220]">{t(`trust.${key}.title`)}</p>
