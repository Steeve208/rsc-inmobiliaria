...
export function BusinessesListing({
  results,
  catalog,
  filters,
  view,
        ...
        <div className="grid items-start gap-4 lg:grid-cols-[240px_minmax(0,1fr)] xl:grid-cols-[240px_minmax(0,1fr)_260px]">
          ...
          <section className="min-w-0">
            <nav className="text-xs text-[#6B7285]">
              ...
              <span>{t("breadcrumbBusinesses")}</span>
            </nav>
            ...
            <div className="mt-2 flex items-start justify-between gap-4">
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url(https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=720&q=80)",
                  }}
                />
          ...
          <div className="sticky top-24 hidden xl:block">
            <ListingAside
              ...
              highlightedId={highlightedId}
              onHighlight={onHighlight}
              onSelectType={(type) => onChange({ type })}
              onExpandMap={() => {
                setMapOpen(true);
                onViewChange("map");
              }}
