...
const cardClassName =
  "group flex h-full items-start gap-4 rounded-[18px] border border-[rgba(255,255,255,.08)] bg-[#111827] p-[30px] transition-all duration-300 hover:-translate-y-1 hover:border-[#1E9B8C] hover:bg-[#161F31] hover:shadow-[0_25px_60px_rgba(0,0,0,.35)]";
    ...
    <section className="pt-[50px]">
      <div className="rk-container grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {cards.map((card, index) => {
          ...
          const body = (
            <>
              <div className="flex size-[50px] shrink-0 items-center justify-center rounded-[14px] bg-[#1E9B8C]/12 text-[#1E9B8C] transition-colors duration-300 group-hover:bg-[#1E9B8C]/20">
