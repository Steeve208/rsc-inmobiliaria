            ...
            return (
              ...
              >
                {index < steps.length - 1 && (
                  <div
                    className="pointer-events-none absolute left-[calc(50%+30px)] top-7 hidden h-px w-[calc(100%-30px)] border-t border-dashed border-[#1E9B8C]/35 xl:block"
                    aria-hidden
                  />
                )}
                <div className="relative z-10 flex size-14 items-center justify-center rounded-full border border-[#1E9B8C]/45 bg-[#111827] text-[#1E9B8C]">
                  <Icon className="size-5" strokeWidth={1.75} />
                </div>
                <p className="mt-3 text-xs font-semibold text-[#1E9B8C]">{index + 1}</p>
