  ...
  return (
    <section className="pt-[80px]">
      <div className="rk-container">
        ...
        >
          <div className="pointer-events-none absolute -right-8 top-1/2 hidden h-72 w-72 -translate-y-1/2 rounded-full bg-[#1E9B8C]/20 blur-3xl lg:block" />
          <div className="pointer-events-none absolute right-8 top-1/2 hidden -translate-y-1/2 lg:block" aria-hidden>
            <div className="relative flex size-48 items-center justify-center rounded-full border border-[#1E9B8C]/35 bg-[#1E9B8C]/10 shadow-[0_0_80px_rgba(214,166,46,0.28)]">
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="flex size-20 items-center justify-center rounded-2xl bg-[#070B14]/70 text-[#1E9B8C] ring-1 ring-[#1E9B8C]/40">
              ...
              <span className="absolute -bottom-3 rounded-full bg-[#1E9B8C] px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-[#070B14]">
                {t("badge")}
              </span>
            </div>
          </div>
          ...
          <div className="relative flex h-full min-h-[260px] max-w-2xl flex-col justify-center lg:min-h-[280px]">
            <p className="inline-flex items-center gap-2 text-sm font-semibold uppercase tracking-wider text-[#1E9B8C]">
