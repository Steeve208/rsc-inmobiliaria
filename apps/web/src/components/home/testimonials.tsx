      ...
      <div className="rk-container">
        ...
        <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
          {reviews.map((review, index) => (
            ...
            >
              <div className="relative mx-auto flex size-20 items-center justify-center overflow-hidden rounded-full bg-[#0E1422] ring-2 ring-[#1E9B8C]/40">
                {review.avatarUrl ? (
                  <Image
              ...
              <div className="mt-4 flex justify-center gap-1 text-[#1E9B8C]">
